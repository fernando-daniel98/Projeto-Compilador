...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_NUM = 3,                        /* NUM  */
  YYSYMBOL_ID = 4,                         /* ID  */
  YYSYMBOL_ENDOFFILE = 5,                  /* ENDOFFILE  */
  ...
  YYSYMBOL_BEGCOMM = 32,                   /* BEGCOMM  */
  YYSYMBOL_CLOSCOMM = 33,                  /* CLOSCOMM  */
...
static const yytype_uint8 yyrline[] =
{
      ...
      42,    45,    48,    49,    52,    53,    56,    57,    60,    63,
      64,    67,    68,    71,    72,    73,    74,    75,    78,    79,
      82,    83,    86,    89,    90,    93,    94,    97,    98,   101,
     102,   105,   106,   107,   108,   109,   110,   113,   114,   117,
     118,   121,   122,   125,   126,   129,   130,   131,   132,   135,
     138,   139,   142,   143,   146
};
#endif
...
static const char *const yytname[] =
{
  ...
  "ENDOFFILE", "ERROR", "IF", "ELSE", "INT", "RETURN", "VOID", "WHILE",
  "PLUS", "MINUS", "MULT", "DIV", "SMAL", "SMALEQ", "GREAT", "GREATEQ",
  "EQ", "DIFF", "ASSIGN", "SEMICOL", "COMMA", "LPAREN", "RPAREN",
  "LBRACKET", "RBRACKET", "LBRACE", "RBRACE", "BEGCOMM", "CLOSCOMM",
  ...
  "ativacao", "args", "arg_lista", "vazio", YY_NULLPTR
};
...
{
       0,   -42,   -42,     6,     0,   -42,   -42,    10,   -42,   -42,
     -42,    30,   -42,    53,    18,    25,    23,    34,    11,   -42,
      14,    38,    45,     0,    44,    47,   -42,   -42,   -42,   -42,
     -42,     0,   -42,   -42,    73,    -2,   -42,    16,   -42,    39,
      52,     9,    55,   -42,    12,   -42,   -42,   -42,   -42,   -42,
     -42,   -42,    56,    59,   -42,    28,    54,   -42,   -42,    12,
      12,    12,   -42,    60,    12,    61,   -42,    12,   -42,   -42,
     -42,   -42,   -42,   -42,   -42,   -42,    12,    12,   -42,   -42,
      12,   -42,    62,    65,   -42,    50,    64,   -42,    66,   -42,
     -42,   -42,    58,    54,   -42,   -42,    12,   -42,    27,    27,
     -42,   -42,   -42
};
...
static const yytype_int8 yydefact[] =
{
      ...
      17,    64,    20,    19,     0,     0,    22,     0,    58,    37,
       0,     0,     0,    29,     0,    18,    24,    21,    23,    25,
      26,    27,     0,    56,    36,    40,    48,    52,    57,    64,
       0,     0,    33,     0,     0,     0,    28,     0,    49,    50,
      41,    42,    43,    44,    45,    46,     0,     0,    53,    54,
       0,    63,     0,    60,    61,     0,     0,    34,     0,    55,
      35,    56,    39,    47,    51,    59,     0,    38,     0,     0,
      62,    30,    32
};
...
{
     -42,   -42,   -42,    79,    63,    -6,   -42,   -42,   -42,    69,
      74,   -42,   -42,   -25,   -42,   -42,   -42,   -42,   -41,   -17,
     -42,   -42,    19,   -42,     8,   -42,     7,   -42,   -42,   -42,
     -27
};
...
{
      63,    38,    39,    65,    36,    40,     9,    16,    41,     1,
      42,     2,    38,    39,    11,    38,    39,    16,    81,    85,
      86,    20,    43,    88,    44,    34,    90,    21,    26,    45,
      38,    39,    84,    62,    40,    44,    23,    41,    44,    42,
      12,    68,    69,    24,    14,    70,    71,    72,    73,    74,
      75,    43,   -13,    44,    12,   100,    13,    26,    14,    91,
      91,    22,     1,    91,    15,    59,    25,    60,    29,    78,
      79,    68,    69,   101,   102,    26,    30,    37,    61,    97,
      66,    64,    67,    10,    87,    93,     0,    94,    89,    95,
      96,    98,    28,    99,    33,    92,    27
};

static const yytype_int8 yycheck[] =
{
      41,     3,     4,    44,    31,     7,     0,    13,    10,     9,
      12,    11,     3,     4,     4,     3,     4,    23,    59,    60,
      61,     3,    24,    64,    26,    31,    67,     4,    30,    31,
       3,     4,    59,    24,     7,    26,    25,    10,    26,    12,
      24,    13,    14,    29,    28,    17,    18,    19,    20,    21,
      22,    24,    27,    26,    24,    96,    26,    30,    28,    76,
      77,    27,     9,    80,    11,    26,    28,    28,    24,    15,
      16,    13,    14,    98,    99,    30,    29,     4,    26,    29,
      24,    26,    23,     4,    24,    77,    -1,    80,    27,    27,
      25,    27,    23,    27,    31,    76,    22
};
...
{
       0,     9,    11,    35,    36,    37,    38,    39,    40,     0,
      37,     4,    24,    26,    28,    11,    39,    41,    42,    43,
       3,     4,    27,    25,    29,    28,    30,    44,    43,    24,
      29,    45,    64,    38,    39,    46,    64,     4,     3,     4,
       7,    10,    12,    24,    26,    31,    44,    47,    48,    49,
      50,    51,    52,    53,    54,    56,    58,    60,    61,    26,
      28,    26,    24,    52,    26,    52,    24,    23,    13,    14,
      17,    18,    19,    20,    21,    22,    55,    57,    15,    16,
      59,    52,    62,    63,    64,    52,    52,    24,    52,    27,
      52,    53,    56,    58,    60,    27,    25,    29,    27,    27,
      52,    47,    47
};
